<div align="center">
  <img src="../../public/icon/128.png" alt="YouTube Live Chat Fullscreen ロゴ" width="128" />
</div>
...
<p align="center">
  ...
  Chrome・Firefox対応 · 55 ロケール（49 言語） · アカウント不要 · トラッキングなし · オープンソース
</p>
...
<tr>
<td colspan="2"><img src="../../.github/screenshots/fullscreen-chat-overview.png" alt="YouTubeストリームのフルスクリーンチャットオーバーレイ" width="960" /></td>
</tr>
<tr>
...
<tr>
<td align="center"><img src="../../.github/screenshots/popup-light.png" alt="ポップアップ UI（ライトテーマ）" width="320" /></td>
<td align="center"><img src="../../.github/screenshots/popup-dark.png" alt="ポップアップ UI（ダークテーマ）" width="320" /></td>
</tr>
<tr>
...
<tr>
<td><img src="../../.github/screenshots/settings-setting-light.png" alt="設定パネル（ライトテーマ）" width="480" /></td>
<td><img src="../../.github/screenshots/settings-setting-dark.png" alt="設定パネル（ダークテーマ）" width="480" /></td>
</tr>
</table>
...
オーバーレイはブラウザ内で動作し、設定もそこに留まります。視聴行動を分析サービスやトラッキングサービスに送信することはありません。

- **アカウント不要・データ収集なし:** 個人データを収集しません
- **設定はローカル:** 外観、レイアウト、プリセット、バックアップはブラウザのストレージに残ります
- **最小限の権限:** `activeTab` と `storage` のみ
- **実装は公開:** ソースコードとリリースパイプラインはこのリポジトリで確認できます
...
- 単一の WXT コードベースから Chrome / Firefox 両方をビルド
