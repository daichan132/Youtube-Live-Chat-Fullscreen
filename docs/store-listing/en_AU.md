...
Text: 10px to 40px, 13px by default — 40px is about three times the size of normal chat text. Resizing the panel never changes the size you picked. Set the text colour, a separate one for membership names, and one of 50 fonts, Japanese faces included; each applies as you pick it.
