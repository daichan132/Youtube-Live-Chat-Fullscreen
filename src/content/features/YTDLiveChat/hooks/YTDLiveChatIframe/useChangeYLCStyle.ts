...
export const useChangeYLCStyle = () => {
	...
	const { changeDisplay: changeUserNameDisplay } =
		useYLCUserNameDisplayChange();
	const { changeDisplay: changeUserIconDisplay } =
		useYLCUserIconDisplayChange();
	const { changeDisplay: changeReactionButtonDisplay } =
		useYLCReactionButtonDisplayChange();
	const { changeDisplay: changeSuperChatBarDisplay } =
		useYLCSuperChatBarDisplayChange();
	const changeYLCStyle = useCallback(
		({
			...
			if (reactionButtonDisplay !== undefined)
				changeReactionButtonDisplay(reactionButtonDisplay);
			if (superChatBarDisplay !== undefined)
				changeSuperChatBarDisplay(superChatBarDisplay);
		},
		[
			changBgColor,
			changFontColor,
