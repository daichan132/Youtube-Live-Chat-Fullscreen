...
export const YTDLiveChatSwitch = () => {
  ...
  return (
    <button type='button' className={`ytp-button ${styles.button}`} aria-pressed={ytdLiveChat} onClick={handleClick} onKeyUp={() => {}}>
      <IoChatboxSharp size={'50%'} className={styles.icon} />
    </button>
  )
}
