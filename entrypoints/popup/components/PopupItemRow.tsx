...
export const PopupItemRow = ({ icon: Icon, title, data, isLast, actionWidth = 'default' }: PopupItemRowProps) => {
  ...
  return (
    <>
      <div className='flex flex-wrap justify-between items-center gap-3 px-3 py-2 opacity-100 transition-all duration-200 rounded-lg hover:bg-[var(--ylc-hover-surface)]'>
        <div
          className={
