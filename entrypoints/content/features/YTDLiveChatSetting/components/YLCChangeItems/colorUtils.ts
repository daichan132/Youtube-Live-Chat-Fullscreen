...
export const toRgba = (c: RGBA): RgbaColor => ({ r: c.r, g: c.g, b: c.b, a: c.a })
export const fromRgba = (c: RgbaColor): RGBA => ({ r: c.r, g: c.g, b: c.b, a: c.a })
...
export const formatColorValue = (rgba: RGBA): string => {
...
export const getPreviewBorderColor = (rgba: RGBA) => {
  const alpha = rgba.a
