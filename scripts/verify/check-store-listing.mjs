...
// One pattern pair per locale: the token carrying the ordinary-comment capability
// in that locale's summary, and the one carrying Super Chat. Anchor on the posting
// verb wherever the language has one -- a bare noun keeps matching after the
// capability is demoted to reading. See the note at the top of this file for what
...
const SUMMARY_CAPABILITIES = {
  ...
  en: [/\bcomment(s|ing)?\b/i, /super\s*chats?/i],
  en_US: [/\bcomment(s|ing)?\b/i, /super\s*chats?/i],
  en_GB: [/\bcomment(s|ing)?\b/i, /super\s*chats?/i],
  en_AU: [/\bcomment(s|ing)?\b/i, /super\s*chats?/i],
}
